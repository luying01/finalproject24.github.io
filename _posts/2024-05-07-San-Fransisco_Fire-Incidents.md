...
### RRegional economic level is positively related to rescue arrival speed
...
we started by analyzing the data from the data sets at our disposal and thus arrived at the realization of the two figures below/above.
